#
#  Be sure to run `pod spec lint JRAuditableEntityUI.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Joshua L. Rasmussen"
  # s.authors            = { "Joshua L. Rasmussen" => "xlr8runner@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Joshua L. Rasmussen"
  ...
  # s.dependency "JRAuditableEntity", :path => "../JRAuditableEntity"
